<template>
  <div class="w-full xl:w-[28rem] relative max-h-[calc(100%-32px)]">
    <div class="p-0.5 flex flex-col relative overflow-hidden rounded-2xl border border-muted my-0 dark:text-gray-50">
