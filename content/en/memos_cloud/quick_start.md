...
When building applications with large language models, a common question is: **How can AI remember users' long-term preferences?**
...
In a new session, the user asks AI to recommend National Day travel destinations and hotels. MemOS will automatically recall 【Factual Memory: Places visited before】【Preference Memory: Hotel booking preferences】 for AI's reference, enabling more personalized travel plan recommendations.
::
