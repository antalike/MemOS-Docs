...
In a new session, the user asks the AI to recommend National Day travel destinations and hotels. MemOS will automatically recall 【Factual Memory: Places visited before】【Preference Memory: Hotel booking preferences】 for the AI's reference, enabling more personalized travel plan recommendations.
::
  ...
  preference_detail_list [
    {
      ...
      "reasoning": "7 Days Inn is typically known for being economical and affordable. The user's choice of 7 Days Inn may indicate a tendency to prioritize cost-effective options for accommodation. While the user did not explicitly mention budget constraints or specific hotel preferences, choosing 7 Days among the provided options likely reflects a focus on price and practicality.",
      "conversation_id": "0610"
    }
  ],
...
- [Coze × MemOS Plugin Tool](/usecase/frameworks/coze_plugin)
  - Use the MemOS plugin tool available on the Coze platform to directly access cloud service interfaces within your workflows, quickly adding long-term memory capabilities to your Agent.
