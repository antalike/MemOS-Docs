...
When the user proposes 'Recommend National Day travel destinations and hotels' in a new session, MemOS automatically recalls 【Fact Memory: Places visited before】 and 【Preference Memory: Hotel booking preferences】 for AI reference, thereby generating a more personalized travel plan.
::
...
# Preference Type Memories
{
  preference_detail_list [
    ...
    },
    {
      ...
      "preference": "The user expects hotel ratings to be no lower than 4.5 stars.",
