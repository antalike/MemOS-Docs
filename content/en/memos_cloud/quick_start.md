---
title: Quick Start
desc: Welcome to the MemOS cloud platform. Follow this beginner's guide to integrate memory capabilities within minutes.
---

When building applications with large language models, a common question is: **How can AI stably remember users' long-term preferences?**
...
* Prepare an environment capable of sending HTTP requests (Python or cURL are both acceptable);

* Obtain an API Key [(Click to get)](https://memos-dashboard.openmem.net/apikeys) and configure it in your environment variables;

* Prepare a `conversation_id` for testing (suggest naming it by date, e.g., `20260413-demo`).
...
When the user proposes 'Recommend National Day travel destinations and hotels' in a new session, MemOS automatically recalls 【Fact Memory: Where they have been】 and 【Preference Memory: Hotel booking preferences】 for the AI to reference, thereby generating a more personalized travel plan.
::
...
# Preference Type Memories
{
  preference_detail_list [
    ...
    {
      "preference_type": "explicit_preference",  # Explicit preference
      "preference": "The user expects hotel ratings to be no lower than 4.5 points.",
...
Now you can run MemOS. It is recommended to continue exploring more features of the cloud platform:
...
* [**SDK Integration Guide**](/api_docs/start/quickstart): View initialization, authentication, and error handling methods by language.
...
- [LangChain × MemOS Integration](/usecase/frameworks/langchain)
  - Integrate `searchMemory` as a retrieval tool within LangChain workflows, supporting multi-turn dialogue context enhancement.
