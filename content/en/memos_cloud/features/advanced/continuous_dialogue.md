...
| Retrieve Specific Knowledge Base | `knowledgebase_ids` | Specify the scope of project-associated knowledge bases available for this retrieval, see [**Knowledge Base**](/memos_cloud/features/advanced/knowledgebase_base). |
