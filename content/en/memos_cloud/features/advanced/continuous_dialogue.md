...
Interface Output Limit: Retrieved memory count — 25 factual memories; 25 preference memories; 25 tool memories.
...
| :--- | :--- | :--- |
| Select Model | model\_name | Currently MemOS provides three models you can specify for responses. You can view detailed model introductions in ++Console - Model List++. Optional model names:<br>* Qwen2.5-72B-Instruct (Default)<br> <br>* Qwen2.5-32B<br> <br>* deepseek-r1 |
