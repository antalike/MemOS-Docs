...
description: Create a knowledge base associated with the project, and combine user memory with knowledge base to supplement knowledge when retrieving memories.
---
