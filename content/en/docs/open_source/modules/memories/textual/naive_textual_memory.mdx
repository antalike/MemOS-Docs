...
description: The most lightweight memory module in MemOS, designed for rapid prototyping and simple scenarios. No vector database required—quickly retrieve memories using keyword matching.
---
...
**Performance Tip**<br />
When memory count exceeds 1000, it's recommended to upgrade to [GeneralTextMemory](/open_source/modules/memories/textual/general_textual_memory), which uses vector search for better performance.
...
- [GeneralTextMemory](/open_source/modules/memories/textual/general_textual_memory) - Vector semantic search, suitable for 10K-100K memories
- [TreeTextMemory](/open_source/modules/memories/textual/tree_textual_memory) - Graph structure storage, supports relationship reasoning and multi-hop queries
...
- **Upgrade to Vector Search**: Learn about [GeneralTextMemory](/open_source/modules/memories/textual/general_textual_memory)'s semantic retrieval capabilities
- **Explore Graph Structure**: Understand [TreeTextMemory](/open_source/modules/memories/textual/tree_textual_memory)'s relationship reasoning features
...
- **Learn Graph Databases**: If you need advanced features, learn about [Neo4j](/open_source/modules/memories/textual/neo4j_graph_db) or [PolarDB](/open_source/modules/memories/textual/polardb_graph_db)
