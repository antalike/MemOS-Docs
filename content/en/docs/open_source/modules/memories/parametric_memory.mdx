...
- **[GeneralTextMemory](/open_source/modules/memories/textual/general_textual_memory)**: Flexible vector-based semantic storage.
- **[TreeTextMemory](/open_source/modules/memories/textual/tree_textual_memory)**: Structured, hierarchical knowledge graphs.
