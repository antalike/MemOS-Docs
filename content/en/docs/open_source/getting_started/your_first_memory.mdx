...
description: Let’s build your first plaintext memory in MemOS! **GeneralTextMemory** is the easiest way to get hands-on with extracting, embedding, and searching simple text memories.
---
...
- **Explore [TreeTextMemory](/open_source/modules/memories/textual/tree_textual_memory):** Build a graph-based,
  hierarchical memory.
