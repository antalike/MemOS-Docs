...
description: Complete installation guide for MemOS.
---

<Cards>

<Card title={"Install via Docker"} icon={<Icon name="ri:database-2-line" />} href="/open_source/getting_started/installation#from-docker">

Ideal for quick deployment: one-click startup for services and dependencies.

</Card>

<Card title={"Install from Source"} icon={<Icon name="ri:play-line" />} href="/open_source/getting_started/installation#from-source">

Ideal for development and contribution: editable installation, run tests, local debugging.

</Card>

<Card title={"Install via pip"} icon={<Icon name="ri:tree-line" />} href="/open_source/getting_started/installation#from-pip">
...
<div style={{textAlign: "center", marginTop: "10px"}}>Example of applying for API_KEY and BASE_URL in Bailian</div>
...
<div style={{textAlign: "center", marginTop: "10px"}}>Example image, port according to custom docker configuration</div>
