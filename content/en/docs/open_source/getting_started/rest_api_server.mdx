...
description: MemOS provides a REST API service written using FastAPI. Users can perform all operations via REST interfaces.
---

![MemOS Architecture](https://cdn.memtensor.com.cn/img/memos_run_server_success_compressed.png)

<div style={{textAlign: "center", marginTop: "10px"}}>APIs supported by MemOS REST API Server</div>
...
<div style={{textAlign: "center", marginTop: "10px"}}>Bailian application API_KEY and BASE_URL example</div>
...
<div style={{textAlign: "center", marginTop: "10px"}}>Example image, port as per docker custom configuration</div>
