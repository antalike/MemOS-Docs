...
description: Extract fact and preference memories from dialogue using the in-house memos-extractor-0.6b model.
---
...
<Tabs items={["Facts + preferences","Facts only","Preferences only"]}>

<Tab value="Facts + preferences">
