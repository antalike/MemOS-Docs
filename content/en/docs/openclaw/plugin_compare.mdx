...
description: The cloud plugin is for quick MemOS Cloud adoption, while the local plugin brings local-first long-term memory and self-evolution to OpenClaw and Hermes. This guide helps you choose the right option.
---
