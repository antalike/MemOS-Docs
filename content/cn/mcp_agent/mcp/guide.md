...
环境变量获取方式：
- `MEMOS_API_KEY`: 在MemOS官网[API控制台]({{dashboardUrl}}/cn/apikeys/)上注册账号，然后在接口密钥页面新建api-key并复制粘贴在此处。

![在MemOS API控制台上新建api-key]({{cdnUrl}}/img/1763452232848_t268eh_compressed.png)
...
![在Claude中使用MemOS-验证]({{cdnUrl}}/img/1763105334517_9ayhrp_compressed.png)
...
![在Claude Desktop中使用MemOS-修改用户偏好]({{cdnUrl}}/img/1763105396189_i1tupr_compressed.png)

下面是在Claude Desktop中使用MemOS的示例，用户可借此判断是否已经成功在Claude Desktop中配置MemOS。

![在Claude Desktop中使用MemOS的示例]({{cdnUrl}}/img/1763105412700_asgfq9_compressed.png)
...
![在Cursor中使用MemOS]({{cdnUrl}}/img/1763105278297_n23ukk_compressed.png)
...
![在Cursor中使用MemOS-配置User rules]({{cdnUrl}}/img/1763105535408_2xtvd3_compressed.png)

下面是在Cursor中使用MemOS的示例，用户可借此判断是否成功在Cursor中配置MemOS。

![在Cursor中使用MemOS-使用示例]({{cdnUrl}}/img/1763105558821_imga5z_compressed.png)
...
![在Cline中使用MemOS-配置流程]({{cdnUrl}}/img/1763105573529_oo765m_compressed.png)
...
![在VS Code或Trae中使用MemOS-修改global rules]({{cdnUrl}}/img/1763105598614_p0drfo_compressed.png)

下面是在Cline中使用MemOS的示例，用户可借此判断是否成功在Cline中配置了MemOS。

![在Cline中使用MemOS的示例]({{cdnUrl}}/img/1763105618134_ggy3m0_compressed.png)
...
![在Chatbox中使用MemOS-验证]({{cdnUrl}}/img/1763105637530_f98hyr_compressed.png)
...
![在Chatbox中使用MemOS时修改system_prompt]({{cdnUrl}}/img/1763105656492_ky1wbw_compressed.png)

下面是在Chatbox中使用MemOS的示例，用户可借此判断是否已经成功在Chatbox中配置MemOS。

![在Chatbox中使用MemOS-效果示例]({{cdnUrl}}/img/1763105677226_cygzzf_compressed.png)
