...
title: MemOS算法原理概述
icon: ri:cpu-line
description: 让大模型从一次性对话工具，进化为真正具有长期记忆和自适应能力的智能体。
---
...
<figure style={{width: "fit-content"}}>
  ...
  <figcaption style={{textAlign: "center"}}>标准化 MemCube（记忆立方体）的基础构成</figcaption>
</figure>
...
<figure style={{width: "fit-content"}}>
  ...
  <figcaption style={{textAlign: "center"}}>记忆调度的核心思路</figcaption>
</figure>
...
*   了解[云服务与开源方案](/cn/memos_cloud/getting_started/cloud_and_opensource)，体验MemOS的强大之处吧!
