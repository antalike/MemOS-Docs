...
title: 工具调用ToolCall
icon: ri:tools-line
description: "添加工具调用信息，将工具调用的决策、执行结果及其使用轨迹统一纳入\_MemOS\_记忆。"
---
...
**[需要先在addMessage的时候传入工具记忆（点此查看详细 API 文档）](/cn/api_docs/core/add_message)**
<br />

**[才能在searchMemory的时候搜索到工具记忆（点此查看详细 API 文档）](/cn/api_docs/core/search_memory)**
<br />
<br />
...
有关 API 字段、格式等信息的完整列表，详见[Add Message 接口文档](/cn/api_docs/core/add_message)查看如何添加工具调用信息。
