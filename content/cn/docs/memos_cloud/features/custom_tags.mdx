...
**[需要先在addMessage的时候传入tag list（点此查看详细 API 文档）](/cn/api_docs/core/add_message)**
<br />

**[才能在searchMemory的时候使用标签进行过滤（点此查看详细 API 文档）](/cn/api_docs/core/search_memory)**
<br />
<br />
