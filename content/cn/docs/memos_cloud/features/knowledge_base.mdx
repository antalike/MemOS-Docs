...
description: 创建项目关联的知识库，检索时结合记忆与知识库。
---

<Callout type="warn">

**[本文是对【MemOS知识库】功能做展开介绍，可点此直接查看详细 API 文档](/cn/api_docs/knowledge/create_kb)**
...
有关反馈 API 字段、格式等信息的完整列表，详见[Add Feedback 接口文档](/cn/api_docs/message/add_feedback)。
...
技能文件的详细工作原理与使用示例，请查看 [记忆自进化](/cn/memos_cloud/features/self-evolving) 中的完整示例。

</Callout>

<Tabs items={["Python (HTTP)"]}>
