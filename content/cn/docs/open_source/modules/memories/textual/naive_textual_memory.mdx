...
**性能提示**<br />
当记忆数量超过 1000 条时，建议升级到 [GeneralTextMemory](/cn/open_source/modules/memories/textual/general_textual_memory)，它使用向量搜索，性能更优。
...
**升级路径**<br />
对于上述不推荐的场景，建议升级到：
- [GeneralTextMemory](/cn/open_source/modules/memories/textual/general_textual_memory) - 向量语义搜索，适合 10K-100K 条记忆
- [TreeTextMemory](/cn/open_source/modules/memories/textual/tree_textual_memory) - 图结构存储，支持关系推理和多跳查询
...
- **升级到向量搜索**：学习 [GeneralTextMemory](/cn/open_source/modules/memories/textual/general_textual_memory) 的语义检索能力
- **探索图结构**：了解 [TreeTextMemory](/cn/open_source/modules/memories/textual/tree_textual_memory) 的关系推理功能
- **集成到应用**：查看 [完整 API 文档](/cn/api-reference/search-memories) 构建生产级应用
- **运行示例代码**：浏览 `/examples/` 目录获取更多实战案例
- **了解图数据库**：如果需要高级功能，可以学习 [Neo4j](/cn/open_source/modules/memories/textual/neo4j_graph_db) 或 [PolarDB](/cn/open_source/modules/memories/textual/polardb_graph_db)
