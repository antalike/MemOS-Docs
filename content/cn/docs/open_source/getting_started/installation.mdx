...
description: MemOS 完整安装指南。
---

<Cards>

<Card title={"通过Docker安装"} icon={<Icon name="ri:database-2-line" />} href="/cn/open_source/getting_started/installation#通过docker安装">

适合快速部署：一键启动服务与依赖组件。

</Card>

<Card title={"从源码安装"} icon={<Icon name="ri:play-line" />} href="/cn/open_source/getting_started/installation#从源码安装">

适合二次开发与贡献：可编辑安装、可跑测试、可本地调试。

</Card>

<Card title={"通过pip安装"} icon={<Icon name="ri:tree-line" />} href="/cn/open_source/getting_started/installation#通过pip安装">
...
<div style={{textAlign: "center", marginTop: "10px"}}>百炼申请 API_KEY和 BASE_URL 示例</div>
...
<div style={{textAlign: "center", marginTop: "10px"}}>示例图片，端口按 docker 自定义的配置</div>
...
2. .env 内容，快速配置请见 docker 安装下的[env 配置](/cn/open_source/getting_started/installation#2.-.env-内容)
.env详细配置请见[env配置](/cn/open_source/getting_started/rest_api_server/#本地运行)
...
2. 示例 .env 内容
.env详细配置请见[env配置](/cn/open_source/getting_started/rest_api_server)

有关详细的开发环境设置、工作流程指南和贡献最佳实践，请参阅我们的 [贡献指南](/cn/open_source/contribution/overview)。
